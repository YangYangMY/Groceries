    ...
    <asp:Panel ID="PanelAddProduct" runat="server" Visible="True">
        ...
        <div class=" bg-white shadow rounded-lg shadow-xl border-solid border-2 w-4/5 mx-auto">
            ...
            <div class="flex justify-left mx-10">
                <div>
                    <div class="relative mb-3 xl:w-96">
                        <asp:TextBox ID="TextBoxProductBrand" runat="server" CssClass=" peer m-0 block h-[58px] w-full rounded border border-solid border-gray-300 bg-white bg-clip-padding py-4 px-3 text-base font-normal leading-tight text-gray-700 ease-in-out placeholder:text-transparent focus:border-primary focus:bg-white focus:pt-[1.625rem] focus:pb-[0.625rem] focus:text-neutral-700 focus:shadow-te-primary focus:outline-none  [&:not(:placeholder-shown)]:pt-[1.625rem] [&:not(:placeholder-shown)]:pb-[0.625rem]"
            ...
            <div class="flex justify-left mx-10">
                <div>
                    <div class="relative mb-3 xl:w-96">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass=" peer m-0 block h-[58px] w-full rounded border border-solid border-gray-300 bg-white bg-clip-padding py-4 px-3 text-base font-normal leading-tight text-gray-700 ease-in-out placeholder:text-transparent focus:border-primary focus:bg-white focus:pt-[1.625rem] focus:pb-[0.625rem] focus:text-neutral-700 focus:shadow-te-primary focus:outline-none  [&:not(:placeholder-shown)]:pt-[1.625rem] [&:not(:placeholder-shown)]:pb-[0.625rem]"
