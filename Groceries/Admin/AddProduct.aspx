                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <asp:TextBox ID="TextBoxProductName" placeholder="Noodles" runat="server" CssClass="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" MaxLength="50"></asp:TextBox>
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="TextBoxUnitPrice" placeholder="5.00" runat="server" CssClass="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"></asp:TextBox>
