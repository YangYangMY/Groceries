        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 font-semibold text-gray-900 ">Calbee Honey Butter Chips (60g)
                    </td>
                    <td class="px-6 py-4">
                ...
                <tr class="bg-white border-b ">
                    ...
                    <td class="px-6 py-4 font-semibold text-gray-900 ">White Rabbit Creamy Candy (108g)
                    </td>
                    <td class="px-6 py-4">
                        <a href="#" class="font-medium text-red-600  hover:underline">Remove</a>
                    </td>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td class="px-6 py-4 font-semibold text-gray-900">CJ Bibigo Original Korea Dumplings Kimchi & Pork (525g)
                    </td>
                    <td class="px-6 py-4">
                        <a href="#" class="font-medium text-red-600  hover:underline">Remove</a>
                    </td>
