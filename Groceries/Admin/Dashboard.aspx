                ...
                <div class="overflow-x-auto rounded-lg">
                    <div class="align-middle inline-block min-w-full">
                        <div class="shadow overflow-hidden sm:rounded-lg">
                            ...
                            <asp:GridView ID="GridViewOrder" runat="server" AutoGenerateColumns="False" DataKeyNames="OrderID" DataSourceID="SqlDataSource1" PageSize="5">
                                <Columns>
                                    <asp:BoundField DataField="OrderID" HeaderText="Order ID" InsertVisible="False" ReadOnly="True" SortExpression="OrderID" HeaderStyle-CssClass=" bg-gray-50 p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" ItemStyle-CssClass="p-4 whitespace-nowrap text-sm font-normal text-gray-900" />
                                    <asp:BoundField DataField="CustomerName" HeaderText="Buyer" SortExpression="CustomerName" HeaderStyle-CssClass="bg-gray-50 p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" ItemStyle-CssClass="p-4 whitespace-nowrap text-sm font-semibold" />
                                    <asp:BoundField DataField="OrderDate" HeaderText="Date" SortExpression="OrderDate" HeaderStyle-CssClass="bg-gray-50 p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" ItemStyle-CssClass="p-4 whitespace-nowrap text-sm font-normal text-gray-900" />
                                    <asp:BoundField DataField="TotalPrice" HeaderText="Amount" SortExpression="TotalPrice" HeaderStyle-CssClass="bg-gray-50 p-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" ItemStyle-CssClass="p-4 whitespace-nowrap text-sm font-semibold" />
                                </Columns>
                            </asp:GridView>
